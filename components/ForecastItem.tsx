...
export const ForecastItem = ({ item, isEditing, onStartEdit, onCancelEdit, onApplyEdit }: ForecastItemProps) => {
        ...
        return (
            <div className="bg-cyan-900/30 p-3 rounded-lg border border-cyan-700 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <span className="text-gray-500 font-bold text-sm w-8 flex-shrink-0">R{item.round}</span>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 flex-grow w-full">
                         <div>
                            <label className="text-xs text-gray-400">{t('forecast.startTimeLabel')}</label>
    ...
    return (
        <div className="bg-gray-800 p-3 rounded-lg hover:bg-gray-700/50 transition-colors">
